...
public class DigitalClock extends RelativeLayout {
    ...
    private Context mContext = null;   //add by zhengwenhui
    ...
    public DigitalClock(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;  //add by zhengwenhui
    }
    ...
    protected void onFinishInflate() {
        ...
        mTimeDisplay.setTypeface(Typeface.createFromFile("/system/fonts/HelveticaNeueLTPro-ThEx.otf"));
        mAmPm = new AmPm(this, Typeface.createFromFile("/system/fonts/HelveticaNeueLTPro-ThEx.otf"));
        mCalendar = Calendar.getInstance();
